...
public class WB_Hexagon implements WB_Transformable3D {
	...
	@Override
	public WB_Hexagon apply2D(final WB_Transform2D T) {
		return new WB_Hexagon(p1.apply2D(T), p2.apply2D(T), p3.apply2D(T), p4.apply2D(T), p5.apply2D(T), p6.apply2D(T));
	}

	@Override
	public WB_Hexagon apply2DSelf(final WB_Transform2D T) {
		p1.apply2DSelf(T);
		p2.apply2DSelf(T);
		p3.apply2DSelf(T);
		p4.apply2DSelf(T);
	...
	@Override
	public WB_Hexagon apply(final WB_Transform3D T) {
		return new WB_Hexagon(p1.apply(T), p2.apply(T), p3.apply(T), p4.apply(T), p5.apply(T), p6.apply(T));
	}

	@Override
	public WB_Hexagon applySelf(final WB_Transform3D T) {
		p1.applySelf(T);
		p2.applySelf(T);
		p3.applySelf(T);
		p4.applySelf(T);
