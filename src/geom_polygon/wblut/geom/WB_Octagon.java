...
public class WB_Octagon implements WB_Transformable3D {
	...
	@Override
	public WB_Octagon apply2D(final WB_Transform2D T) {
		return new WB_Octagon(p1.apply2D(T), p2.apply2D(T), p3.apply2D(T), p4.apply2D(T), p5.apply2D(T), p6.apply2D(T),
				p7.apply2D(T), p8.apply2D(T));
	}

	@Override
	public WB_Octagon apply2DSelf(final WB_Transform2D T) {
		p1.apply2DSelf(T);
		p2.apply2DSelf(T);
		p3.apply2DSelf(T);
		p4.apply2DSelf(T);
	...
	@Override
	public WB_Octagon apply(final WB_Transform3D T) {
		return new WB_Octagon(p1.apply(T), p2.apply(T), p3.apply(T), p4.apply(T), p5.apply(T), p6.apply(T), p7.apply(T),
				p8.apply(T));
	}

	@Override
	public WB_Octagon applySelf(final WB_Transform3D T) {
		p1.applySelf(T);
		p2.applySelf(T);
		p3.applySelf(T);
		p4.applySelf(T);
