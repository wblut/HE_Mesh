 ...
 *
 */
public class HEC_FromWBMesh extends HEC_Creator {
	/**
	 ...
	 * @param source
	 */
	public HEC_FromWBMesh(final WB_Mesh source) {
		super();
		this.source = source;
		duplicate = true;
		normalcheck = true;
	 ...
	 * @param source
	 */
	public HEC_FromWBMesh(final WB_MeshCreator source) {
		super();
	 ...
	 * @return self
	 */
	public HEC_FromWBMesh setDuplicate(final boolean b) {
		duplicate = b;
		return this;
	}
