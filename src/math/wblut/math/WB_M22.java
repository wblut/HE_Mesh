...
public class WB_M22 {
	 ...
	 */
	public WB_M22(final double[][] matrix33) {
		m11 = matrix33[0][0];
		m12 = matrix33[0][1];
		m13 = matrix33[0][2];
		m21 = matrix33[1][0];
	 ...
	 *            m33
	 */
	public WB_M22(final double m11, final double m12, final double m13, final double m21, final double m22,
	 ...
	 */
	public WB_M22 get() {
		return new WB_M22(m11, m12, m13, m21, m22, m23, m31, m32, m33);
	}
	 ...
	 *            result
	 */
	public void addInto(final WB_M22 m, final WB_M22 result) {
	 ...
	 *            result
	 */
	public void subInto(final WB_M22 m, final WB_M22 result) {
		result.m11 = m11 - m.m11;
		result.m12 = m12 - m.m12;
		result.m13 = m13 - m.m13;
		result.m21 = m21 - m.m21;
	 ...
	 *            result
	 */
	public void multInto(final double f, final WB_M22 result) {
		result.m11 = f * m11;
		result.m12 = f * m12;
		result.m13 = f * m13;
		result.m21 = f * m21;
	...
	public WB_M22 getTranspose() {
		return new WB_M22(m11, m21, m31, m12, m22, m32, m13, m23, m33);
	}
	 ...
	 *            result
	 */
	public void transposeInto(final WB_M22 result) {
	...
	public static WB_Vector Cramer3(final double a1, final double b1, final double c1, final double d1, final double a2,
			...
			final double d3) {
		final WB_M22 m = new WB_M22(a1, b1, c1, a2, b2, c2, a3, b3, c3);
	...
	public WB_M22 Jacobi() {
		...
		final WB_M22 a = get();
		double[][] am = a.toArray();
		final WB_M22 J = new WB_M22(1, 0, 0, 0, 1, 0, 0, 0, 1);
		WB_M22 JT = new WB_M22();
		final WB_M22 v = new WB_M22(1, 0, 0, 0, 1, 0, 0, 0, 1);
	 ...
	 */
	public static WB_M22 covarianceMatrix(final WB_Coord[] points) {
		int n = points.length;
		...
		final WB_M22 cov = new WB_M22(e00, e01, e02, e01, e11, e12, e02, e12, e22);
		cov.mul(oon);
		return cov;
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof WB_M22)) {
			return false;
		}
		final WB_M22 p = (WB_M22) o;
