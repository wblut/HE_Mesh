...
public class WB_GeometryFactory2D {
	 ...
	 * @return coordinate
	 */
	public WB_CoordinateSystem createCSFromOX2D(final WB_Coord origin,
			final WB_Coord X) {
	 ...
	 * @return coordinate system
	 */
	public WB_CoordinateSystem createCSFromOXY2D(final WB_Coord origin,
	...
	public WB_Polygon createSimplePolygon(final WB_Pentagon pentagon) {
		return new WB_Polygon(pentagon.p1, pentagon.p2, pentagon.p3,
				pentagon.p4, pentagon.p5);
	}

	public WB_Polygon createSimplePolygon(final WB_Hexagon hexagon) {
		return new WB_Polygon(hexagon.p1, hexagon.p2, hexagon.p3, hexagon.p4,
				hexagon.p5, hexagon.p6);
	}

	public WB_Polygon createSimplePolygon(final WB_Octagon octagon) {
		return new WB_Polygon(octagon.p1, octagon.p2, octagon.p3, octagon.p4,
				octagon.p5, octagon.p6, octagon.p7, octagon.p8);
	}
		...
		if (WB_GeometryOp2D.classifyPointToCircle2D(p,
			...
			if (tangentcircle) {
				...
				p1 = createInversionPoint2D(
						WB_Point.addMul(C.getCenter(), C.getRadius(), X2D()),
						inversion);
				p2 = createInversionPoint2D(
						WB_Point.addMul(C.getCenter(), -C.getRadius(), X2D()),
						inversion);
				final WB_Point p3 = createInversionPoint2D(
						WB_Point.addMul(C.getCenter(), C.getRadius(), Y2D()),
						inversion);
				final WB_Circle invC = createCirclePPP(p1, p2, p3);
				final List<WB_Line> invResult = createLinesTangentTo2Circles(
						invL, invC);
