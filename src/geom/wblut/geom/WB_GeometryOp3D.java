...
public class WB_GeometryOp3D extends WB_GeometryOp2D {
	 ...
	 * @return
	 */
	public static List<WB_AABBNode> getIntersection3D(final WB_Ray R,
	 ...
	 * @return
	 */
	public static List<WB_AABBNode> getIntersection3D(final WB_AABB aabb,
			final WB_AABBTree tree) {
		final List<WB_AABBNode> result = new ArrayList<WB_AABBNode>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		queue.add(tree.getRoot());
	...
	public static List<WB_AABBNode[]> getIntersection3D(final WB_AABBTree tree1,
			final WB_AABBTree tree2) {
		final List<WB_AABBNode[]> result = new ArrayList<WB_AABBNode[]>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		...
		while (!queue.isEmpty()) {
			...
			if (checkIntersection3D(current.getAABB(), tree2)) {
				if (current.isLeaf()) {
					for (WB_AABBNode node : getIntersection3D(current.getAABB(),
							tree2)) {
	...
	public static List<WB_AABBNode> getIntersection3D(final WB_Coord p,
			final WB_AABBTree tree) {
		final List<WB_AABBNode> result = new ArrayList<WB_AABBNode>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		queue.add(tree.getRoot());
	 ...
	 * @return
	 */
	public static List<WB_AABBNode> getIntersection3D(final WB_Line L,
			final WB_AABBTree tree) {
		final List<WB_AABBNode> result = new ArrayList<WB_AABBNode>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		queue.add(tree.getRoot());
	 ...
	 * @return
	 */
	public static List<WB_AABBNode> getIntersection3D(final WB_Segment S,
			final WB_AABBTree tree) {
		final List<WB_AABBNode> result = new ArrayList<WB_AABBNode>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		queue.add(tree.getRoot());
	 ...
	 * @return
	 */
	public static List<WB_AABBNode> getIntersection3D(final WB_Plane P,
			final WB_AABBTree tree) {
		final List<WB_AABBNode> result = new ArrayList<WB_AABBNode>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		queue.add(tree.getRoot());
	 ...
	 * @return
	 */
	public static List<WB_AABBNode> getIntersection3D(final WB_Triangle T,
			final WB_AABBTree tree) {
		final List<WB_AABBNode> result = new ArrayList<WB_AABBNode>();
		final LinkedList<WB_AABBNode> queue = new LinkedList<WB_AABBNode>();
		queue.add(tree.getRoot());
	...
	public static boolean isEqual(final WB_Plane P, final WB_Plane Q) {
		if (!WB_Epsilon
				.isZero(WB_GeometryOp3D.getDistance3D(P.getOrigin(), Q))) {
			return false;
		}
		if (!WB_Epsilon
				.isZero(WB_GeometryOp3D.getDistance3D(Q.getOrigin(), P))) {
			return false;
		}
