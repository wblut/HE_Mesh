...
public class WB_GeometryFactory3D extends WB_GeometryFactory2D {
	 ...
	 * @return coordinate
	 */
	public WB_CoordinateSystem createCSFromOX(final WB_Coord origin,
			final WB_Coord X) {
	 ...
	 * @return coordinate system
	 */
	public WB_CoordinateSystem createCSFromOXY(final WB_Coord origin,
	 ...
	 * @return
	 */
	public WB_CoordinateSystem createCSFromOXYZ(final WB_Coord origin,
	...
	public WB_Polygon[] splitSimplePolygon(final WB_Polygon poly,
		...
		if (numVerts > 0) {
			...
			WB_Classification aSide = WB_GeometryOp3D.classifyPointToPlane3D(a,
					P);
			WB_Point b;
	...
	public WB_Circle createInversionCircle(final WB_Circle C,
		...
		if (WB_GeometryOp3D.classifyPointToCircle2D(inversionCircle.getCenter(),
	 ...
	 * @return
	 */
	public WB_Mesh createMesh(final Collection<? extends WB_Coord> points,
			final int[][] faces) {
		return new WB_Mesh(points, faces);
	}
	 ...
	 * @return
	 */
	public WB_Mesh createTriMesh(final Collection<? extends WB_Coord> points,
			final int[][] faces) {
		return new WB_TriangleMesh(points, faces);
	}
	 ...
	 * @return
	 */
	public WB_Mesh createRegularPrism(final int n, final double radius,
			final double h) {
	 ...
	 * @return
	 */
	public WB_Mesh createPrism(final Collection<? extends WB_Coord> points,
			final double h) {
	 ...
	 * @return
	 */
	public WB_Mesh createPrismOpen(final Collection<? extends WB_Coord> points,
			final double h) {
		final WB_Vector offset = createVector(0, 0, h);
		final List<WB_Point> lpoints = new FastList<WB_Point>();
		for (final WB_Coord point : points) {
	 ...
	 * @return
	 */
	public WB_Mesh createRegularAntiPrism(final int n, final double radius,
			final double h) {
	 ...
	 * @return
	 */
	public WB_Mesh createAntiPrism(final Collection<? extends WB_Coord> points,
			final double h) {
		final WB_Vector offset = createVector(0, 0, h);
		final List<WB_Point> lpoints = new FastList<WB_Point>();
		for (final WB_Coord point : points) {
	 ...
	 * @return
	 */
	public WB_Mesh createOtherPolyhedron(final int type,
	 ...
	 * @return
	 */
	public WB_Mesh createZonohedron(final WB_Coord[] vectors,
			final double scale) {
	 ...
	 * @return
	 */
	public WB_Mesh createStellatedIcosahedron(final int type,
			final double radius) {
	 ...
	 * @return
	 */
	public WB_Mesh createDipyramidWithAngleRange(
	 ...
	 * @return
	 */
	public WB_Mesh createDipyramidWithAngleRange(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createDipyramidWithAngle(
	 ...
	 * @return
	 */
	public WB_Mesh createDipyramidWithAngle(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createDipyramidWithHeight(
	 ...
	 * @return
	 */
	public WB_Mesh createDipyramidWithHeight(final WB_Coord[] points,
			final double height) {
	 ...
	 * @return
	 */
	public WB_Mesh createTaperWithAnglesAndHeight(
	 ...
	 * @return
	 */
	public WB_Mesh createTaperWithAnglesAndHeight(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createTaperWithAngleRangeAndHeight(
			final Collection<? extends WB_Coord> points, final double minangle,
	 ...
	 * @return
	 */
	public WB_Mesh createTaperWithAngleRangeAndHeight(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createTaperWithAngleAndHeight(
			final Collection<? extends WB_Coord> points, final double angle,
			final double height, final WB_Map2D context) {
	 ...
	 * @return
	 */
	public WB_Mesh createTaperWithAngleAndHeight(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createBitaperWithAnglesAndHeight(
			final Collection<? extends WB_Coord> points, final double[] angles,
			final double height, final boolean b, final boolean t,
			final WB_Map2D context) {
		final Corner[] corners = new Corner[points.size()];
	 ...
	 * @return
	 */
	public WB_Mesh createBitaperWithAnglesAndHeight(final WB_Coord[] points,
			final double[] angles, final double height, final boolean b,
			final boolean t, final WB_Map2D context) {
		final Corner[] corners = new Corner[points.length];
		// final WB_Point local = createPoint();
	 ...
	 * @return
	 */
	public WB_Mesh createBitaperWithAngleRangeAndHeight(
			final Collection<? extends WB_Coord> points, final double minangle,
			final double maxangle, final double height, final boolean b,
			final boolean t, final WB_Map2D context) {
		final Corner[] corners = new Corner[points.size()];
	 ...
	 * @return
	 */
	public WB_Mesh createBitaperWithAngleRangeAndHeight(final WB_Coord[] points,
			final double minangle, final double maxangle, final double height,
			final boolean b, final boolean t, final WB_Map2D context) {
		final Corner[] corners = new Corner[points.length];
		// final WB_Point local = createPoint();
	 ...
	 * @return
	 */
	public WB_Mesh createBitaperWithAngleAndHeight(
			final Collection<? extends WB_Coord> points, final double angle,
			final double height, final WB_Map2D context) {
	 ...
	 * @return
	 */
	public WB_Mesh createBitaperWithAngleAndHeight(final WB_Coord[] points,
			final double angle, final double height, final WB_Map2D context) {
		return createBitaperWithAngleRangeAndHeight(points, angle, angle,
				height, true, true, context);
	}
	 ...
	 * @return
	 */
	public WB_Mesh createCapsuleWithAnglesAndHeight(
			final Collection<? extends WB_Coord> points, final double[] angles,
	 ...
	 * @return
	 */
	public WB_Mesh createCapsuleWithAngleRangeAndHeight(
			final Collection<? extends WB_Coord> points, final double minangle,
	 ...
	 * @return
	 */
	public WB_Mesh createCapsuleWithAngleAndHeight(
			final Collection<? extends WB_Coord> points, final double angle,
			final double height, final double cap, final boolean b,
			final boolean t, final WB_Map2D context) {
		final double[] angles = new double[points.size()];
	 ...
	 * @return
	 */
	public WB_Mesh createCapsuleWithAnglesAndHeight(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createCapsuleWithAngleRangeAndHeight(final WB_Coord[] points,
			final double minangle, final double maxangle, final double height,
	 ...
	 * @return
	 */
	public WB_Mesh createCapsuleWithAngleAndHeight(final WB_Coord[] points,
	 ...
	 * @return
	 */
	WB_Mesh createSpindleWithAnglesAndHeight(
			final Collection<? extends WB_Coord> points, final double[] angles,
	 ...
	 * @return
	 */
	public WB_Mesh createSpindle(final Collection<? extends WB_Coord> points,
			final double height, final double cap, final WB_Map2D context) {
		final double[] angles = new double[points.size()];
		for (int i = 0; i < points.size(); i++) {
	 ...
	 * @return
	 */
	WB_Mesh createSpindleWithAnglesAndHeight(final WB_Coord[] points,
			final double[] angles, final double height, final double cap,
			final WB_Map2D context) {
		final Corner[] corners = new Corner[points.length];
		// final WB_Point local = createPoint();
	 ...
	 * @return
	 */
	public WB_Mesh createSpindle(final WB_Coord[] points, final double height,
	 ...
	 * @return
	 */
	public WB_Mesh createConvexHullWithThreshold(final WB_Coord[] points,
	 ...
	 * @return
	 */
	public WB_Mesh createConvexHullWithThreshold(
